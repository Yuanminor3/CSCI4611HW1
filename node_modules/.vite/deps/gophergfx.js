...
var _Quaternion = class {
  ...
  static lookAt(eye, target, up = Vector3.UP) {
...
var _Matrix4 = class {
  ...
  transformPoint(v) {
    ...
    result.x = w2 * (this.mat[0] * v.x + this.mat[4] * v.y + this.mat[8] * v.z + this.mat[12]);
    result.y = w2 * (this.mat[1] * v.x + this.mat[5] * v.y + this.mat[9] * v.z + this.mat[13]);
    result.z = w2 * (this.mat[2] * v.x + this.mat[6] * v.y + this.mat[10] * v.z + this.mat[14]);
    return result;
  }
  transformVector(v) {
    const result = new Vector3();
...
var U = class {
  ...
  debug(t) {
    this.verbosity <= U.Verbosity.DEBUG && console.debug(t);
  }
  info(t) {
    this.verbosity <= U.Verbosity.INFO && console.info(t);
  }
  warn(t) {
    this.verbosity <= U.Verbosity.WARN && console.warn(t);
  }
  error(t) {
    this.verbosity <= U.Verbosity.ERROR && console.error(t);
  }
};
function B(t, e, r) {
...
U.Verbosity = F, U.DEFAULT_INSTANCE = new U(U.Verbosity.INFO);
var P = class {
  static identity(t) {
    return t;
  }
  ...
  static denormalize(t, e) {
    return P.decodeNormalizedInt(t, e);
  }
  ...
  static normalize(t, e) {
    return P.encodeNormalizedInt(t, e);
  }
...
var W = class {
  ...
  static basename(t) {
    return N.basename(new URL(t, V).pathname);
  }
  static extension(t) {
    return N.extension(new URL(t, V).pathname);
  }
  static resolve(t, e) {
...
W.DEFAULT_INIT = {}, W.PROTOCOL_REGEXP = /^[a-zA-Z]+:\/\//;
var q = (t) => t;
var H = /* @__PURE__ */ new Set();
var Y = class extends GraphNode {
  constructor(t, r = "") {
...
var K = class extends Z {
  constructor(...t) {
    super(...t), this.i = P.identity, this.o = P.identity;
  }
  init() {
    this.propertyType = h.ACCESSOR;
  }
  getDefaults() {
    return Object.assign(super.getDefaults(), { array: null, type: K.Type.SCALAR, componentType: K.ComponentType.FLOAT, normalized: false, sparse: false, buffer: null });
  }
  copy(t, e = q) {
  ...
  static getComponentSize(t) {
    switch (t) {
      case K.ComponentType.BYTE:
      case K.ComponentType.UNSIGNED_BYTE:
        return 1;
      case K.ComponentType.SHORT:
      case K.ComponentType.UNSIGNED_SHORT:
        return 2;
      case K.ComponentType.UNSIGNED_INT:
      case K.ComponentType.FLOAT:
        return 4;
      default:
  ...
  getElementSize() {
    return K.getElementSize(this.get("type"));
  }
  getComponentSize() {
  ...
  setNormalized(t) {
    return this.set("normalized", t), t ? (this.o = (t2) => P.decodeNormalizedInt(t2, this.get("componentType")), this.i = (t2) => P.encodeNormalizedInt(t2, this.get("componentType"))) : (this.o = P.identity, this.i = P.identity), this;
  }
  getScalar(t) {
    const e = this.getElementSize();
  ...
  setArray(t) {
    return this.set("componentType", t ? function(t2) {
      switch (t2.constructor) {
        case Float32Array:
          return K.ComponentType.FLOAT;
        case Uint32Array:
          return K.ComponentType.UNSIGNED_INT;
        case Uint16Array:
          return K.ComponentType.UNSIGNED_SHORT;
        case Uint8Array:
          return K.ComponentType.UNSIGNED_BYTE;
        case Int16Array:
          return K.ComponentType.SHORT;
        case Int8Array:
          return K.ComponentType.BYTE;
        default:
          throw new Error("Unknown accessor componentType.");
      }
    }(t) : K.ComponentType.FLOAT), this.set("array", t), this;
  }
  getByteLength() {
    const t = this.get("array");
...
K.Type = { SCALAR: "SCALAR", VEC2: "VEC2", VEC3: "VEC3", VEC4: "VEC4", MAT2: "MAT2", MAT3: "MAT3", MAT4: "MAT4" }, K.ComponentType = { BYTE: 5120, UNSIGNED_BYTE: 5121, SHORT: 5122, UNSIGNED_SHORT: 5123, UNSIGNED_INT: 5125, FLOAT: 5126 };
...
X.TargetPath = { TRANSLATION: "translation", ROTATION: "rotation", SCALE: "scale", WEIGHTS: "weights" };
var tt = class extends Z {
  init() {
    this.propertyType = h.ANIMATION_SAMPLER;
  }
  getDefaultAttributes() {
    return Object.assign(super.getDefaults(), { interpolation: tt.Interpolation.LINEAR, input: null, output: null });
  }
  getInterpolation() {
...
tt.Interpolation = { LINEAR: "LINEAR", STEP: "STEP", CUBICSPLINE: "CUBICSPLINE" };
...
var rt = class extends Z {
  ...
  getDefaults() {
    return Object.assign(super.getDefaults(), { type: rt.Type.PERSPECTIVE, znear: 0.1, zfar: 100, aspectRatio: null, yfov: 2 * Math.PI * 50 / 360, xmag: 1, ymag: 1 });
  }
  getType() {
    return this.get("type");
  }
...
rt.Type = { PERSPECTIVE: "perspective", ORTHOGRAPHIC: "orthographic" };
...
st.EXTENSION_NAME = void 0;
var nt = class extends Z {
  init() {
    this.propertyType = h.TEXTURE_INFO;
  }
  getDefaults() {
    return Object.assign(super.getDefaults(), { texCoord: 0, magFilter: null, minFilter: null, wrapS: nt.WrapMode.REPEAT, wrapT: nt.WrapMode.REPEAT });
  }
  getTexCoord() {
...
nt.WrapMode = { CLAMP_TO_EDGE: 33071, MIRRORED_REPEAT: 33648, REPEAT: 10497 }, nt.MagFilter = { NEAREST: 9728, LINEAR: 9729 }, nt.MinFilter = { NEAREST: 9728, LINEAR: 9729, NEAREST_MIPMAP_NEAREST: 9984, LINEAR_MIPMAP_NEAREST: 9985, NEAREST_MIPMAP_LINEAR: 9986, LINEAR_MIPMAP_LINEAR: 9987 };
var { R: it, G: ot, B: at, A: ut } = d;
var ct = class extends Z {
  init() {
    this.propertyType = h.MATERIAL;
  }
  getDefaults() {
    return Object.assign(super.getDefaults(), { alphaMode: ct.AlphaMode.OPAQUE, alphaCutoff: 0.5, doubleSided: false, baseColorFactor: [1, 1, 1, 1], baseColorTexture: null, baseColorTextureInfo: new nt(this.graph, "baseColorTextureInfo"), emissiveFactor: [0, 0, 0], emissiveTexture: null, emissiveTextureInfo: new nt(this.graph, "emissiveTextureInfo"), normalScale: 1, normalTexture: null, normalTextureInfo: new nt(this.graph, "normalTextureInfo"), occlusionStrength: 1, occlusionTexture: null, occlusionTextureInfo: new nt(this.graph, "occlusionTextureInfo"), roughnessFactor: 1, metallicFactor: 1, metallicRoughnessTexture: null, metallicRoughnessTextureInfo: new nt(this.graph, "metallicRoughnessTextureInfo") });
  }
  getDoubleSided() {
  ...
  setBaseColorTexture(t) {
    return this.setRef("baseColorTexture", t, { channels: it | ot | at | ut, isColor: true });
  }
  getEmissiveFactor() {
  ...
  setEmissiveTexture(t) {
    return this.setRef("emissiveTexture", t, { channels: it | ot | at, isColor: true });
  }
  getNormalScale() {
  ...
  setNormalTexture(t) {
    return this.setRef("normalTexture", t, { channels: it | ot | at });
  }
  ...
  setOcclusionTexture(t) {
    return this.setRef("occlusionTexture", t, { channels: it });
  }
  getRoughnessFactor() {
  ...
  setMetallicRoughnessTexture(t) {
    return this.setRef("metallicRoughnessTexture", t, { channels: ot | at });
  }
};
ct.AlphaMode = { OPAQUE: "OPAQUE", MASK: "MASK", BLEND: "BLEND" };
...
var ft = class extends Z {
  ...
  getMatrix() {
    return P.compose(this.get("translation"), this.get("rotation"), this.get("scale"), []);
  }
  setMatrix(t) {
    const e = this.get("translation").slice(), r = this.get("rotation").slice(), s = this.get("scale").slice();
    return P.decompose(t, e, r, s), this.set("translation", e).set("rotation", r).set("scale", s);
  }
  getWorldTranslation() {
    const t = [0, 0, 0];
    return P.decompose(this.getWorldMatrix(), t, [0, 0, 0, 1], [1, 1, 1]), t;
  }
  getWorldRotation() {
    const t = [0, 0, 0, 1];
    return P.decompose(this.getWorldMatrix(), [0, 0, 0], t, [1, 1, 1]), t;
  }
  getWorldScale() {
    const t = [1, 1, 1];
    return P.decompose(this.getWorldMatrix(), [0, 0, 0], [0, 0, 0, 1], t), t;
  }
  getWorldMatrix() {
    const t = [];
...
var lt = class extends Z {
  ...
  getDefaults() {
    return Object.assign(super.getDefaults(), { mode: lt.Mode.TRIANGLES, material: null, indices: null, attributes: {}, targets: [] });
  }
  getIndices() {
...
lt.Mode = { POINTS: 0, LINES: 1, LINE_LOOP: 2, LINE_STRIP: 3, TRIANGLES: 4, TRIANGLE_STRIP: 5, TRIANGLE_FAN: 6 };
...
var yt = class extends Z {
  ...
  copy(t, e = q) {
    ...
    this.set("asset", gt({}, t.get("asset"))), this.setName(t.getName()), this.setExtras(gt({}, t.getExtras())), this.setDefaultScene(t.getDefaultScene() ? e(t.getDefaultScene()) : null);
  ...
  g(t) {
    return t instanceof pt ? this.addRef("scenes", t) : t instanceof ft ? this.addRef("nodes", t) : t instanceof rt ? this.addRef("cameras", t) : t instanceof mt ? this.addRef("skins", t) : t instanceof ht ? this.addRef("meshes", t) : t instanceof ct ? this.addRef("materials", t) : t instanceof wt ? this.addRef("textures", t) : t instanceof Q ? this.addRef("animations", t) : t instanceof K ? this.addRef("accessors", t) : t instanceof et && this.addRef("buffers", t), this;
  }
  getAsset() {
...
var vt = class {
  static fromGraph(t) {
    return vt.v.get(t) || null;
  }
  constructor() {
    this.T = new Graph(), this.S = new yt(this.T), this.M = U.DEFAULT_INSTANCE, vt.v.set(this.T, this);
  }
  getRoot() {
    return this.S;
  }
  ...
  clone() {
    return new vt().setLogger(this.M).merge(this);
  }
  merge(t) {
  ...
  createPrimitiveTarget(t = "") {
    return new dt(this.T, t);
  }
  createMaterial(t = "") {
    return new ct(this.T, t);
  }
  createTexture(t = "") {
    return new wt(this.T, t);
  }
  createAnimation(t = "") {
    return new Q(this.T, t);
  }
  ...
  createAccessor(t = "", e = null) {
    return e || (e = this.getRoot().listBuffers()[0]), new K(this.T, t).setBuffer(e);
  }
  createBuffer(t = "") {
    return new et(this.T, t);
  }
};
vt.v = /* @__PURE__ */ new WeakMap();
var Tt = class {
  constructor(t) {
    this.extensionName = "", this.prereadTypes = [], this.prewriteTypes = [], this.readDependencies = [], this.writeDependencies = [], this.document = void 0, this.required = false, this.properties = /* @__PURE__ */ new Set(), this.I = void 0, this.document = t, t.getRoot().p(this), this.I = (t2) => {
      ...
      r instanceof st && r.extensionName === this.extensionName && ("node:create" === e2.type && this.N(r), "node:dispose" === e2.type && this.O(r));
    };
    const e = t.getGraph();
...
var xt = { logger: U.DEFAULT_INSTANCE, extensions: [], dependencies: {} };
var At = class {
  static read(t, e = xt) {
    const r = gt({}, xt, e), { json: s } = t, n = new vt().setLogger(r.logger);
    this.validate(t, r);
    const i = new bt(t), o = s.asset, a = n.getRoot().getAsset();
    o.copyright && (a.copyright = o.copyright), o.extras && (a.extras = o.extras), void 0 !== s.extras && n.getRoot().setExtras(gt({}, s.extras));
    ...
    i.accessors = d2.map((t2) => {
      ...
      return t2.extras && e2.setExtras(t2.extras), void 0 !== t2.normalized && e2.setNormalized(t2.normalized), void 0 === t2.bufferView || e2.setArray(Et(t2, i)), e2;
    });
    ...
    n.getRoot().listExtensionsUsed().filter((t2) => t2.prereadTypes.includes(h.PRIMITIVE)).forEach((t2) => t2.preread(i, h.PRIMITIVE)), i.meshes = w2.map((t2) => {
      ...
      if (t2.extras && e2.setExtras(t2.extras), t2.type === rt.Type.PERSPECTIVE) {
    ...
    n.getRoot().listExtensionsUsed().filter((t2) => t2.prereadTypes.includes(h.NODE)).forEach((t2) => t2.preread(i, h.NODE)), i.nodes = y2.map((t2) => {
      ...
      if (t2.extras && e2.setExtras(t2.extras), void 0 !== t2.translation && e2.setTranslation(t2.translation), void 0 !== t2.rotation && e2.setRotation(t2.rotation), void 0 !== t2.scale && e2.setScale(t2.scale), void 0 !== t2.matrix) {
        ...
        P.decompose(t2.matrix, r2, s2, n2), e2.setTranslation(r2), e2.setRotation(s2), e2.setScale(n2);
      }
      ...
      const r2 = (t2.samplers || []).map((t3) => {
        const r3 = n.createAnimationSampler().setInput(i.accessors[t3.input]).setOutput(i.accessors[t3.output]).setInterpolation(t3.interpolation || tt.Interpolation.LINEAR);
    ...
    return n.getRoot().listExtensionsUsed().filter((t2) => t2.prereadTypes.includes(h.SCENE)).forEach((t2) => t2.preread(i, h.SCENE)), i.scenes = v.map((t2) => {
      ...
      (s2 || n2) && r2.setSparse(true).setArray(function(t3, e3) {
        const r3 = p[t3.componentType], s3 = K.getElementSize(t3.type);
        let n3;
        n3 = void 0 !== t3.bufferView ? Et(t3, e3) : new r3(t3.count * s3);
        const i2 = t3.sparse;
        if (!i2)
          return n3;
        const o2 = i2.count, a2 = gt({}, t3, i2.indices, { count: o2, type: "SCALAR" }), u3 = gt({}, t3, i2.values, { count: o2 }), c2 = Et(a2, e3), h2 = Et(u3, e3);
...
function Et(t, e) {
  const r = e.bufferViews[t.bufferView], s = e.jsonDoc.json.bufferViews[t.bufferView], n = p[t.componentType], i = K.getElementSize(t.type), o = n.BYTES_PER_ELEMENT;
  if (void 0 !== s.byteStride && s.byteStride !== i * o)
    return function(t2, e2) {
      const r2 = e2.bufferViews[t2.bufferView], s2 = e2.jsonDoc.json.bufferViews[t2.bufferView], n2 = p[t2.componentType], i2 = K.getElementSize(t2.type), o2 = n2.BYTES_PER_ELEMENT, a2 = t2.byteOffset || 0, u2 = new n2(t2.count * i2), c2 = new DataView(r2.buffer, r2.byteOffset, r2.byteLength), h2 = s2.byteStride;
...
var Mt = class {
  constructor(t, e, r) {
    ...
    this.bufferURIGenerator = new It(n > 1, () => r.basename || "buffer"), this.imageURIGenerator = new It(i > 1, (e2) => function(t2, e3) {
...
Mt.BufferViewTarget = St, Mt.BufferViewUsage = l, Mt.USAGE_TO_TARGET = { [l.ARRAY_BUFFER]: St.ARRAY_BUFFER, [l.ELEMENT_ARRAY_BUFFER]: St.ELEMENT_ARRAY_BUFFER };
var It = class {
  constructor(t, e) {
...
var { BufferViewUsage: Rt } = Mt;
var { UNSIGNED_INT: Nt, UNSIGNED_SHORT: Ot, UNSIGNED_BYTE: Ct } = K.ComponentType;
var Ft = class {
  static write(t, e) {
    const r = t.getRoot(), s = { asset: gt({ generator: `glTF-Transform ${u}` }, r.getAsset()), extras: gt({}, r.getExtras()) }, n = { json: s, resources: {} }, i = new Mt(t, n, e), o = e.logger || U.DEFAULT_INSTANCE, a = new Set(e.extensions.map((t2) => t2.EXTENSION_NAME)), l2 = t.getRoot().listExtensionsUsed().filter((t2) => a.has(t2.extensionName)), d2 = t.getRoot().listExtensionsRequired().filter((t2) => a.has(t2.extensionName));
    ...
    function w2(t2, e2, r2) {
      ...
      return s.bufferViews.push({ buffer: e2, byteOffset: r2, byteLength: a2, byteStride: o2, target: Mt.BufferViewTarget.ARRAY_BUFFER }), { byteLength: a2, buffers: [new Uint8Array(u2)] };
    }
    function y2(t2, e2, r2) {
      ...
      for (const e3 of t2) {
        ...
        for (let t4 = 0, s2 = e3.getCount(); t4 < s2; t4++)
          if (e3.getElement(t4, a3), !P.eq(a3, h3, 0)) {
      ...
      const h2 = c2 < 255 ? Uint8Array : c2 < 65535 ? Uint16Array : Uint32Array, f2 = c2 < 255 ? Ct : c2 < 65535 ? Ot : Nt, l3 = { buffer: e2, byteOffset: r2 + a2, byteLength: 0 };
      for (const e3 of t2) {
        const t3 = u2.get(e3);
        if (0 === t3.count)
          continue;
    ...
    s.buffers = [], r.listBuffers().forEach((t2, r2) => {
      const o2 = i.createPropertyDef(t2), a2 = i.accessorUsageGroupedByParent, u2 = i.accessorParents, h2 = t2.listParents().filter((t3) => t3 instanceof K), l3 = new Set(h2), d3 = [], p2 = s.buffers.length;
      let v2 = 0;
      ...
      for (const t3 in T2)
        if (a2.has(t3))
          for (const r3 of Array.from(u2.values())) {
            ...
            if (s2.length)
              if (t3 !== Rt.ARRAY_BUFFER || e.vertexLayout === f.INTERLEAVED) {
                const e2 = t3 === Rt.ARRAY_BUFFER ? w2(s2, p2, v2) : m2(s2, p2, v2);
          ...
          if (!e2.length)
            continue;
          const r3 = t3 === Rt.ELEMENT_ARRAY_BUFFER ? Mt.BufferViewTarget.ELEMENT_ARRAY_BUFFER : void 0, s2 = t3 === Rt.SPARSE ? y2(e2, p2, v2) : m2(e2, p2, v2, r3);
      ...
      const r2 = i.createPropertyDef(t2);
      if (t2.getAlphaMode() !== ct.AlphaMode.OPAQUE && (r2.alphaMode = t2.getAlphaMode()), t2.getAlphaMode() === ct.AlphaMode.MASK && (r2.alphaCutoff = t2.getAlphaCutoff()), t2.getDoubleSided() && (r2.doubleSided = true), r2.pbrMetallicRoughness = {}, P.eq(t2.getBaseColorFactor(), [1, 1, 1, 1]) || (r2.pbrMetallicRoughness.baseColorFactor = t2.getBaseColorFactor()), P.eq(t2.getEmissiveFactor(), [0, 0, 0]) || (r2.emissiveFactor = t2.getEmissiveFactor()), 1 !== t2.getRoughnessFactor() && (r2.pbrMetallicRoughness.roughnessFactor = t2.getRoughnessFactor()), 1 !== t2.getMetallicFactor() && (r2.pbrMetallicRoughness.metallicFactor = t2.getMetallicFactor()), t2.getBaseColorTexture()) {
      ...
      const r2 = i.createPropertyDef(t2);
      if (r2.type = t2.getType(), r2.type === rt.Type.PERSPECTIVE) {
      ...
      const r2 = i.createPropertyDef(t2);
      return P.eq(t2.getTranslation(), [0, 0, 0]) || (r2.translation = t2.getTranslation()), P.eq(t2.getRotation(), [0, 0, 0, 1]) || (r2.rotation = t2.getRotation()), P.eq(t2.getScale(), [1, 1, 1]) || (r2.scale = t2.getScale()), t2.getWeights().length && (r2.weights = t2.getWeights()), i.nodeIndexMap.set(t2, e2), r2;
...
var Bt = class {
  constructor() {
    this.M = U.DEFAULT_INSTANCE, this.l = /* @__PURE__ */ new Set(), this.U = {}, this.P = f.INTERLEAVED, this.lastReadBytes = 0, this.lastWriteBytes = 0;
  }
  setLogger(t) {
    return this.M = t, this;
  }
  ...
  async readAsJSON(t) {
    ...
    const r = Pt(e) ? this.L(e) : { json: JSON.parse(E.decodeText(e)), resources: {} };
    return await this.j(r, this.dirname(t)), this.D(r), r;
  }
  async readJSON(t) {
    return t = this._(t), this.D(t), At.read(t, { extensions: Array.from(this.l), dependencies: this.U, logger: this.M });
  }
  ...
  async writeJSON(t, e = {}) {
    ...
    return Ft.write(t, { format: e.format || g.GLTF, basename: e.basename || "", logger: this.M, vertexLayout: this.P, dependencies: gt({}, this.U), extensions: Array.from(this.l) });
  }
  async writeBinary(t) {
  ...
  _(t) {
    ...
    return t = { json: gt({}, t.json), resources: gt({}, t.resources) }, e && (t.json.images = e.map((t2) => gt({}, t2))), r && (t.json.buffers = r.map((t2) => gt({}, t2))), t;
  }
  L(t) {
    if (!Pt(t))
